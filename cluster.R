...
# gh_install_packages("RandomFields")
# gh_install_packages("geoR")

devtools::install('E:/packages_R/RandomFields')

install.packages(pkgs = "E:/packages_R/RandomFieldsUtils_1.2.5.tar.gz", type="source", repos=NULL)
install.packages(pkgs = "E:/packages_R/RandomFields_3.3.14.tar.gz", type="source", repos=NULL)

devtools::install('E:/packages_R/geoR')
