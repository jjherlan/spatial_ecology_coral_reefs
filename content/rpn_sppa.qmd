...
```{r}
vhu_window <- owin(c(0, 10), c(0, 25), unitname = 'metre', 'metres')
```
...
scale of the quadrat defined. Note that this test is more akin to a first-order point pattern analysis because it is based on the dispersion of points among sampling quadrats.
